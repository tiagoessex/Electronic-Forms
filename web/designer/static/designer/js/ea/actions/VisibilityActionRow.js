...
/**
 * Visibility E/A Action Row.
 */
 export class VisibilityActionRow extends ActionRow {
    ...
    constructor(context, onAdd, onRemove, data_restore = null) {
        ...
        this.field_selector = new EAElementSelector(context, null, null, EA_TYPE.STATUS.elements_not_allowed.actions).attachTo(col_fields);
        ...
        this.add_field.dom.addEventListener('click', function (e) {
            ...
            const new_row = new VisibilityActionRow(self.context, onAdd, onRemove);
            onAdd(new_row);
            if (anchor)
