...
/**
 * Selection E/A Action Row.
 */
 export class SelectionActionRow extends ActionRow {
    ...
    constructor(context, onAdd, onRemove, data_restore = null) {
        ...
        this.field_selector = new EAElementSelector(context, null, EA_TYPE.SELECTION.elements_allowed.actions).attachTo(col_fields);
