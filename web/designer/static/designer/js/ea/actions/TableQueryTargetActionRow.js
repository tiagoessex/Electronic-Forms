 ...
 */
 export class TableQueryTargetActionRow extends ActionRow {
    ...
    constructor(context, onAdd, onRemove, data_restore=null) {
        ...
        const col_column_selector = new Div({classes:['col-2']}).attachTo(this);
        this.column_selector = new TableColumnSelector(context).attachTo(col_column_selector);

        const col_fields = new Div({classes:['col-8']}).attachTo(this);
        ...
        this.add_field.dom.addEventListener('click', function (e) {
            ...
            const new_row = new TableQueryTargetActionRow(self.context, onAdd, onRemove);
            onAdd(new_row);
            if (anchor)
