...
/**
 * Required E/A Action Row.
 */
 export class RequiredActionRow extends ActionRow {
    ...
    constructor(context, onAdd, onRemove, data_restore = null) {
        ...
        this.field_selector = new EAElementSelector(context, null, null, EA_TYPE.REQUIRED.elements_not_allowed.actions).attachTo(col_fields);
        ...
        this.add_field.dom.addEventListener('click', function (e) {
            ...
            const new_row = new SelectionActionRow(self.context, onAdd, onRemove);
            onAdd(new_row);
            if (anchor)
