...
/**
 * Temporal E/A Action Row.
 */
 export class TemporalActionRow extends ActionRow {
    ...
    constructor(context, onAdd, onRemove, data_restore=null) {
        ...
        this.field_selector = new EAElementSelector(context, null, EA_TYPE.TEMPORAL.elements_allowed.actions).attachTo(col_fields);
        ...
        this.add_field.dom.addEventListener('click', function (e) {
            ...
            const new_row = new TemporalActionRow(self.context, onAdd, onRemove);
            onAdd(new_row);
            if (anchor)
