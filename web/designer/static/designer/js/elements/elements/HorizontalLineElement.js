...
/**
 * Horizontal line => div with bottom border.
 */
export class HorizontalLineElement extends BaseElement {
    /**
     * Constructor.
    ...
    constructor(type=ELEMENTS_TYPE.NONE, props = null, parent=null, context=null, left, top, id, background=null) {
        ...
        this.props[PROPERTIES_ID.BORDERBORDERSPROPERTY] = 'bottom';
        ...
        if (props)                
            this.dom.style.borderStyle = "none none " + props[PROPERTIES_ID.BORDERPROPERTY];
        else
            this.dom.style.borderStyle = "none none solid"; 
