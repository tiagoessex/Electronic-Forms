...
export class PhotoElement extends FormBaseElement {
    constructor(context, props, id) {
        ...
        this.img = new Img(PHOTO_INPUT, width, height).attachTo(div);
        ...
        $(this.button.dom).on('click',function() {
            ...
            context.signals.onFormValueChanged.dispatch(ref.real_id, PHOTO_INPUT, true); 
        });
